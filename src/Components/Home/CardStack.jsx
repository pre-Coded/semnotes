  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide className="w-full flex flex-col items-center bg-[#222222] space-y-3 rounded-lg shadow-lg">
          <span></span>
          <span className="main-text">Solution</span>
          <span className="para-text p-2 text-sm tracking-wider relative flex flex-col space-y-3">
          <span>
        ...
        <SwiperSlide className="w-full flex flex-col items-center bg-[#333333] space-y-3 rounded-lg shadow-lg">
          <span></span>
          <span className="main-text">How ?</span>
          <span className="para-text p-2 hide-scrollbar text-sm tracking-wider relative flex flex-col space-y-3">
